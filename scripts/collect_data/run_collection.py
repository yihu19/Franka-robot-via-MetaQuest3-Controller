...
episodes to HDF5.  Meta Quest 3 right-controller buttons control recording:

    B  – start a new recording episode
    A  – save & stop the current episode
    Ctrl-C – quit
...
from game_controller import QuestController
from cameras import Cameras
from data_recorder import DataRecorder

# teleop_franka_hardware.py owns port 9093 (the robot's state stream) and mirrors
# every packet it receives to port 9094 for use by other local processes.
DEFAULT_STATE_PORT = int(os.environ.get("FRANKA_STATE_PORT", "9094"))
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            start_rec, stop_rec, do_quit = controller.get_recording_controls()
